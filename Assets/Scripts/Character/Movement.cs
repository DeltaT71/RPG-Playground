...
namespace RPG.Character
{
    ...
    public class Movement : MonoBehaviour
    {
        ...
        public void Rotate(Vector3 newForwardVector)
        {
            ...
            transform.rotation = Quaternion.Slerp(startRotation, endRotation, Time.deltaTime * agent.angularSpeed);
        }
        ...
        public bool ReachedDestination()
        {
            ...
            if (agent.remainingDistance > agent.remainingDistance) return false;
