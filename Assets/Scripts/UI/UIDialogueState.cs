...
namespace RPG.UI
{
    public class UIDialogueState : UIBaseState
    {
        ...
        private NPCController npcControllerCpm;
        ...
        public void SetStory(TextAsset inkJSON, GameObject npc)
        {
            ...
            npcControllerCpm = npc.GetComponent<NPCController>();

            currentStory.BindExternalFunction("VerifyQuest", VerifyQuest);

            if (npcControllerCpm.hasQuestItem)
            {
        ...
        private void HandleNewChoices(List<Choice> currentChoices)
        {
            ...
            currentChoices.ForEach(CreateNewChoiceButton);
        ...
        {
            currentStory.variablesState["questCompleted"] = npcControllerCpm.CheckPlayerForQuestItem();
